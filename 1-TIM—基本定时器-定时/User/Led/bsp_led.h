...
#define SSI_GPIO_PORT GPIOC
#define SSI_GPIO_CLK RCC_APB2Periph_GPIOC
#define SSI_GPIO_PIN GPIO_Pin_7

//set switch define

#define SSI_TOGGLE digitalToggle(SSI_GPIO_PORT,SSI_GPIO_PIN)
#define SSI_OFF    digitalHi(SSI_GPIO_PORT,SSI_GPIO_PIN)
#define SSI_ON     digitalLo(SSI_GPIO_PORT,SSI_GPIO_PIN)
